...
def get_user_name():
    """Retrieves current user name from the input field."""
...
def process_command(command):
    """Processes recognized user commands dynamically using the entered name."""
    cmd = command.lower()
...
# User Name Input Frame
name_frame = tk.LabelFrame(root, text=" User Profile ", font=("Helvetica", 10, "bold"), bg="#f4f6f9", padx=10, pady=5)
name_frame.pack(pady=5, fill="x", padx=20)

name_label = tk.Label(name_frame, text="Enter Your Name:", font=("Helvetica", 10), bg="#f4f6f9")
name_label.pack(side="left", padx=5)

name_entry = tk.Entry(name_frame, font=("Helvetica", 10))
name_entry.pack(side="left", fill="x", expand=True, padx=5)
name_entry.insert(0, "User")  # Default placeholder value

# Voice Gender Selection Frame
